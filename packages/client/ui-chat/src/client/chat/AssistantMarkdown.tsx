...
export const AssistantMarkdown = memo(function AssistantMarkdown({
  blocks, streaming, interrupted, renderMessageImages, groupPart, useDisclosure, reasoningPreviewLines,
        ...
        rendered.push(
          ...
          >
            <ReasoningRow text={block.text} running={streaming && i === last} usePresentation={usePresentation}
              useDisclosure={useDisclosure} reasoningPreviewLines={reasoningPreviewLines} t={t} />
          </ProcessReasoning>,
        )
        break
      case 'image': {
